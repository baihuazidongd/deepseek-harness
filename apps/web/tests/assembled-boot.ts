...
const PLUGINS: readonly (WebBootEntry & { bundlePath: string })[] = [
  ...
  { id: '@deepseek-ai/dsh-client-ui-mods', bundlePath: 'packages/client/ui-mods/lib/client.js', url: '/plugins/ui-mods.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-ui-sidebar', '@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-api-remotes'] },
  { id: '@deepseek-ai/dsh-client-ui-skills', bundlePath: 'packages/client/ui-skills/lib/client.js', url: '/plugins/ui-skills.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-ui-sidebar', '@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-api-remotes'] },
  { id: '@deepseek-ai/dsh-client-ui-mcp', bundlePath: 'packages/client/ui-mcp/lib/client.js', url: '/plugins/ui-mcp.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-ui-sidebar', '@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-api-remotes'] },
