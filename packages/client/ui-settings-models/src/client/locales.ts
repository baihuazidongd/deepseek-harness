...
export const en = {
  ...
  modelReasoningEfforts: 'Reasoning effort levels',
  modelReasoningEffortsPlaceholder: 'Comma-separated canonical ids, e.g. off, low, high, max',
  modelReasoningInvalid: 'Unknown level "{level}". Use off, minimal, low, medium, high, xhigh, or max.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelReasoningEfforts: '思考强度档位',
  modelReasoningEffortsPlaceholder: '逗号分隔的档位 ID，例如 off, low, high, max',
  modelReasoningInvalid: '未知档位 "{level}"。可用：off, minimal, low, medium, high, xhigh, max。',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
