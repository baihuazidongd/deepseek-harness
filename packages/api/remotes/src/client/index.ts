...
export type { PluginInventorySetEnabledRequest, PluginInventorySnapshot } from '@deepseek-ai/dsh-host-plugin-inventory/types'
export type { SkillInventoryDetail, SkillInventorySetEnabledRequest, SkillInventorySnapshot } from '@deepseek-ai/dsh-host-skill-inventory/types'
export type { McpInventorySetEnabledRequest, McpInventorySnapshot, McpServerEntry, McpToolView } from '@deepseek-ai/dsh-host-mcp-inventory/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, skillInventoryRemote, mcpInventoryRemote, messageFeedbackRemote,
    ]) {
