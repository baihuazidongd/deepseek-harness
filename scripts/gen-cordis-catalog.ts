...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  userPatchPaths: 'not a service: launcher-provided user patch-layer paths (UserPatchPaths | undefined) — packages/boot/user-patches/README.md owns this launcher contract',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  PluginInventorySetEnabledRequest: 'enablement write request is owned by packages/host/plugin-inventory/src/types.ts',
  PluginInventorySnapshot: 'inventory wire snapshot is owned by packages/host/plugin-inventory/src/types.ts',
