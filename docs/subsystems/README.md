...
| [plugins.md](plugins.md) | the plugin inventory: `PluginInventoryEntry`/`Snapshot`, the per-call Loader projection, package source classification, and profile-layer enablement writes |
